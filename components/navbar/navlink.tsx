        ...
        <>
            {session?.user ? (
                <div className="flex items-center justify-end md:order-2 gap-2">
                    <div className="hidden text-sm bg-gray-50 border rounded-full md:me-0
                    ...
                    <div className="flex items-center">
                        <button onClick={() => signOut()}
                            className="md:block hidden py-2 px-4 bg-gray-100 text-gray-700 hover:bg-gray-200 rounded-sm cursor-pointer">
                            Sign Out
                        </button>
                    </div>
                </div>
            ) : null}
            <button onClick={() => setOpen(!open)} className='inline-flex items-center p2 justify-center text-sm text-gray-500 rounded-md
                ...
                bg-gray-50 md:flex-row md:items-center md:space-x-10 md:p-0 md:mt-0 md:border-0 md:bg-white">
                    ...
                    {session ? (
                        <li className="pt-2 md:pt-0">
                            <button
                                onClick={() => signOut()}
                                className=" md:hidden py-2.5 px-4 bg-red-400 text-white
